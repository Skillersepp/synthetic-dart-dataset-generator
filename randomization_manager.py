...
class RandomizationManager:
    ...
    def __init__(self, global_seed: int, base_path: Path = None, labels_path: Path = None, frame_digits: int = 4):
        ...
        # Annotation Manager
        self.annotation_manager = AnnotationManager(self.throw_randomizer, self.labels_path, self.frame_digits)
