...
PROJECT_DIR = r"/home/student/Schreibtisch/gsplat-main/synthetic-dart-dataset-generator/synthetic-dart-dataset-generator/"
...
def main():
    ...
    # Entspricht: blender -b datei.blend -P skript.py -a
    command = [
        "blender",
        "-b", BLEND_FILE,
        "-P", PYTHON_SCRIPT,
